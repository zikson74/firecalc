                ...
                <div className="flex flex-col md:flex-row items-center gap-6">
                  <ResponsiveContainer width="100%" height={260}>
                    <PieChart>
                      ...
                      <Tooltip formatter={(v) => v != null ? formatLargeNumber(Number(v)) : ""} contentStyle={{ background:"#1F2937", border:"1px solid #374151", borderRadius:12 }} itemStyle={{ color:"#F9FAFB" }} labelStyle={{ color:"#94A3B8" }}/>
                    </PieChart>
                  </ResponsiveContainer>
